...
- `/cantinasec:quickscan` — Heads-up sweep of dependency-risk patterns across pip packages, VS Code extensions, and MCP servers (concern-ranked warnings, not an audit)
